...
import com.community.cms.api.board.service.BoardUseCategoryService;
...
public class BoardUseCategoryController {
	...
	private final BoardUseCategoryService boardUseCategoryService;
	...
	@PostMapping
	public ResponseEntity add(@RequestBody @Valid BoardUseCategoryDto.add addDto) {
		boardUseCategoryService.add(addDto);
