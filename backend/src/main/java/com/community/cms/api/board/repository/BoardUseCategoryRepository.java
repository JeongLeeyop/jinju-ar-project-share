...
public interface BoardUseCategoryRepository extends JpaRepository<BoardUseCategory, String>{
	...
	List<BoardUseCategory> findAllByBoardUidAndChannelUid(String boardUid, String channelUid);
	BoardUseCategory findTop1ByBoardUidAndChannelUidOrderByViewOrderDesc(String boardUid, String channelUid);
	...
	List<BoardUseCategory> findByChannelUid(String channelUid);
}
