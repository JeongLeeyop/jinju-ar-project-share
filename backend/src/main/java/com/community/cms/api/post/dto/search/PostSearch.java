package com.community.cms.api.post.dto.search;
...
import com.community.cms.entity.QPost;
import com.community.cms.entity.QPostData;
...
public class PostSearch {
	...
	public Predicate search() {
		...
		if (StringUtils.hasText(channelUid)) {
			builder.and(post.channel.uid.eq(channelUid));
		}
