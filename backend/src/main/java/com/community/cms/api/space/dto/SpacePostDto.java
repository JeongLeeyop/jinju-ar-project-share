...
public class SpacePostDto {
     ...
     */
    public static SpacePostDto from(SpacePost post, String currentUserUid, boolean isLiked, String iconFileUid) {
        SpacePostDto dto = from(post, currentUserUid, isLiked);
