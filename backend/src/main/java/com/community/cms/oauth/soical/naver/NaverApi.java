package com.community.cms.oauth.soical.naver;
...
public class NaverApi {
    ...
    public ResponseEntity token(String code) {
        UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(HOST+"/oauth2.0/token")
            ...
            // .queryParam("redirect_uri", profile.equals("development") ? "http://leeyop.unids.kr/oauth/token" : "https://royalrise.co.kr/oauth/token")
            .queryParam("redirect_uri", profile.equals("development") ? "http://localhost:3000/oauth/token" : "https://royalrise.co.kr/oauth/token")
    ...
    public ResponseEntity access(String access) {
        ...
        // String url = profile.equals("development") ? "http://leeyop.unids.kr:8080/oauth/token" : "http://royalrise.co.kr/oauth/token";
