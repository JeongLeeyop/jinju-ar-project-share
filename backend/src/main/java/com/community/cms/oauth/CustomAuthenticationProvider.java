...
// import com.community.cms.api.nice.service.NiceService;
...
import com.community.cms.oauth.soical.OAuth2UserInfo;
import com.community.cms.oauth.soical.SocialType;
import com.community.cms.oauth.soical.apple.AppleApi;
import com.community.cms.oauth.soical.apple.AppleUser;
import com.community.cms.oauth.soical.kakao.KakaoApi;
import com.community.cms.oauth.soical.kakao.KakaoUser;
import com.community.cms.oauth.soical.naver.NaverApi;
import com.community.cms.oauth.soical.naver.NaverUser;
...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) {
        ...
        if (details.get("provider_token") != null) {
            ...
            sessionRegistry.registerNewSession(authentication.getName(), new SinghaUser(user, authorities));
