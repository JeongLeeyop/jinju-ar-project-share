package com.community.cms.oauth.soical.apple;
...
public class AppleApi {
    ...
    public static final String CLIENT_ID = "unids.royalrise";
    ...
    public ResponseEntity token(AppleLoginInfo dto) {
        ...
        UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(AUTH_URL+"/auth/token")
            ...
            .queryParam("redirect_uri", profile.equals("development") ? "http://localhost:3000/oauth/token" : "https://royalrise.go.kr/oauth/token");
    ...
    public ResponseEntity access(String access) {
        ...
        String url = profile.equals("development") ? "http://localhost:8080/oauth/token" : "https://royalrise.co.kr/oauth/token";
        // String url = profile.equals("development") ? "ttp://leeyop.unids.kr:8080/oauth/token" : "https://royalrise.co.kr/oauth/token";
