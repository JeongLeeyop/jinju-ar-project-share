  ...
  <div class="user-wrap">
    <div class="user-title">
      ...
      <div class="user__tab small">
        ...
        <router-link :to="{ name: 'ExtraProductAdd' }">추가 +</router-link>
      </div>
    </div>
    ...
    <div class="user-content">
      <el-table v-loading="loading" :header-cell-style="{ background: '#9097a4', color: '#fff', padding: '5px 0' }"
        ...
        <el-table-column prop="name" label="상품명" width=""></el-table-column>
        ...
        <el-table-column label="관리" width="200">
          <template slot-scope="scope">
            <router-link class="detail-button"
              :to="{ name: 'ExtraProductAdd', params: { idx: scope.row.idx } }">보기</router-link>
