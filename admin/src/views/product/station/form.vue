				...
				<div class="product-add-content1">
					...
					<div class="content1-input">
						...
						<!-- <div class="shop-input-wr">
							<el-form-item prop="shopIdx" label="배송 주차 횟수">
							<el-select v-model="form.weekDeliveryCnt">
								<el-option
									v-for="(cnt, index) in weekDeliveryCnt"
									:key="index"
									:label="`${cnt}주`"
									:value="cnt"
								/>
						...
						<div class="shop-input-wr">
							<el-form-item prop="price" label="가격">
								<el-input placeholder="" type="number" min="0" id="productPrice" v-model="form.price" />
							</el-form-item>
						</div>
						<!-- <div class="shop-input-wr">
							<el-form-item prop="deliveryFee" label="배송비">
								<el-input placeholder="" type="number" min="0" id="deliveryFee" v-model="form.deliveryFee" />
							</el-form-item>
						</div> -->
...
export default class extends Vue {
	...
	private rules = {
		...
		// deliveryFee: [
		// 	{ required: true, message: '배송비를 입력하세요.', trigger: 'blur' },
		// ],
		sellStatus: [
