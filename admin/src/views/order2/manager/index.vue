      ...
      >
          ...
          <template slot-scope="scope">
            {{ getNumber(scope.$index) }}
				...
				<el-table-column prop="name" label="이름" width="" />
				<el-table-column prop="shopName" label="픽업매장" width="" />
          ...
          <template slot-scope="scope">
            {{ scope.row.pickupDate | parseDate('YYYY-MM-DD(ddd)') }}
				...
				<el-table-column prop="number" label="연락처" width="" />
...
// import { getProductOrderList, getProductOrderTotalStatistics } from '@/api/manager/productOrder';
import { getProductOrderList, getProductOrderTotalStatistics } from '@/api/manager/productOrder';
