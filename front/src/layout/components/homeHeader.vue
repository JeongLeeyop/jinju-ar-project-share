  ...
  <div class="header home-header">
    <div class="header-left">
      ...
      <div class="header-logo" @click="moveHome">
        <span class="logo-text">
          <span class="logo-primary">진주알</span>
          <span class="logo-secondary">커뮤니티</span>
        </span>
      ...
      <div class="mobile-user-menu-content" @click.stop>
        <div class="mobile-user-header">
          ...
          <div class="mobile-user-info">
            ...
            <span class="mobile-user-points">알 포인트: {{ userPoints.toLocaleString() }}</span>
          </div>
    ...
    <div class="mobile-user-icon" @click="handleMobileUser">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="header-content" :class="{ 'mobile-open': mobileMenuOpen }" v-if="!mobileMenuOpen">
      <div class="aside-btn">
        <slot v-if="!isLogin">
